...
var gapikey = 'AIzaSyB7OhY5sMOrTXdt7OTscywAjkLNHzfKjB0';
...
function search() {
    ...
    $.get(
    	"https://www.googleapis.com/youtube/v3/search?channelId=UCGp4u0WHLsK8OAxnvwiTyhA", {
            part: 'snippet, id',
            q: q,
			type: 'video',
            key: gapikey
